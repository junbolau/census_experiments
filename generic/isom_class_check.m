...
OutputFileName := "./sorted_data/flat25/isom_class" cat Input;
InputFileName := "./data_unfiltered_updated/flat25/" cat Input;
...
while i le L do
    ...
    for eqn in supptmp do
        try 
            ...
            fprintf "./sorted_data/flat25/problematic_automorphisms.txt", "%o" cat "\n", eqn;
