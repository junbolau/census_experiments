...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_25 = Integer(25); _sage_const_569 = Integer(569)
...
for j in range(_sage_const_25 ):
    ...
    for key in lst[_sage_const_569 *j:_sage_const_569 *j + _sage_const_569 ]:
        for eqn in d[key]:
